...
Widget _app({
  ...
  required Map<String, ({String id, String tarifa, bool efectivo})> cuotas,
}) => ProviderScope(
  overrides: [
  ...
  testWidgets('un alumno con cuota en efectivo se distingue de Stripe', (
    ...
    await tester.pumpWidget(
      _app(
        ...
        cuotas: const {
          'a1': (id: 's1', tarifa: 'Mensual', efectivo: true),
          'a2': (id: 's2', tarifa: 'Mensual', efectivo: false),
        },
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('solo se puede retirar una cuota en efectivo, no una de Stripe', (
    ...
    await tester.pumpWidget(
      _app(
        ...
        cuotas: const {'a2': (id: 's2', tarifa: 'Mensual', efectivo: false)},
      ),
    );
    await tester.pumpAndSettle();
