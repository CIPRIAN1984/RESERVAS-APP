...
Future<void> main() async {
  ...
  await Observability.run(() async {
    ...
    // Descongelado el 19/09/2026 junto con Tienda: es lo único que hoy
    // llega a abrir la hoja de pago de Stripe (`catalogo_tab.dart`). Sin
    // clave configurada, `stripePublishableKey` está vacía y esto no hace
    // nada — seguro de dejar siempre encendido.
