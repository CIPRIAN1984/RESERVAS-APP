    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('No se ha podido actualizar el pedido.'),
          ),
        );
      }
    }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pedidosAsync.when(
      ...
      data: (pedidosOriginales) {
        ...
        final pedidos = [...pedidosOriginales]
          ..sort((a, b) {
                ...
                child: Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          pedido.productoNombre ?? 'Producto',
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            Chip(
                              label: Text(_etiquetaPago(pedido.paymentStatus)),
                            ),
